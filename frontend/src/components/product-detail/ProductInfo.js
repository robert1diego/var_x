...
import subscriptions from '../../images/subscription.svg'
...
export default function ProductInfo({
    ...
    useState(variants[selectedVariant].size)
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Grid item>
                    <img src={subscriptions} alt="add item to subscriptions"
                        className={classes.icon}
                    />
                </Grid>
            </Grid>
            ...
            >
                <Grid
                    ...
                    classes={{
                        root: clsx(classes.detailsContainer,
                ...
                <Grid
                    ...
                    classes={{
                        root:
                            clsx(classes.descriptionContainer,
                                classes.sectionContainer)
                    }} >
                    <Grid item>
