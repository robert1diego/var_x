...
export default function ProductList({
  ...
  const [sortOptions, setSortOptions] = useState([
    ...
    { label: "NOVEDADES", active: false, function: data => time(data, 'asc') },
    { label: "ANTIGUOS", active: false, function: data => time(data, 'desc') },
    { label: "PRECIO ↑", active: false, function: data => price(data, 'asc') },
    { label: "PRECIO ↓", active: false, function: data => price(data, 'desc') },
    { label: "RESENAS", active: false, function: data => data },
  ]
